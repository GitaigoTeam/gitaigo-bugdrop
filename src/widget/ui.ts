  ...
  return new Promise(resolve => {
    ...
    const issueInfo =
      isPublic || (issueLinkVisibility === 'always' && shouldShowIssueLink)
        ? `
        <p class="bd-success-issue">Segnalazione <strong>#${issueNumber}</strong> creata.</p>
        ${issueLink}
      `
        : `<p class="bd-success-issue">Il tuo feedback è stato inviato correttamente.</p>`;
    ...
    const modal = createModal(
      ...
      `
        ...
        <div class="bd-actions bd-success-actions">
          <button class="bd-btn bd-btn-primary" data-action="done">Fatto</button>
        </div>
